...
namespace MvcSiteMapAccessright.DI.StructureMap.Registries
{
        ...
        : Registry
    {
        public MvcSiteMapProviderRegistry()
        {
            ...
            bool securityTrimmingEnabled = true;  //need to set true for use custom acl module
            string[] includeAssembliesForScan = new string[] { "MvcSiteMapAccessright" };
...
// Prepare for our node providers
            ...
            this.For<IReservedAttributeNameProvider>().Use<ReservedAttributeNameProvider>()
                .Ctor<IEnumerable<string>>("attributesToIgnore").Is(new string[] { "accessRightExpr" }); //ignore the custom attribute
